...
| name               | The naming pattern to use for the built style files.                                                                      | build.style.name          | --build-style-name          | `"[name].css"`                    | `Unknown`                                            | No       |
...
| port               | Port for the dev server.                                                                                                  | dev.port                  | --dev-port                  | `3002`                            | `Integer`                                            | No       |
...
| Name               | Description                                                                                                               | Path                      | CLI option                  | Default                           | Type                                                 | Required |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------- | ------------------------- | --------------------------- | --------------------------------- | ---------------------------------------------------- | -------- |
| name               | The name of the templates. Uses nunjucks and two variables are available, &quot;name&quot; &amp; &quot;bundlePath&quot;.  | dev.template.name         | --dev-template-name         | `"development.html"`              | `String`                                             | No       |
